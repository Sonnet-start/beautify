...
import { Sparkles, Sun, Moon, Heart, Camera, Calendar, MessageCircle, TrendingUp } from "lucide-react";
...
export default function DesignDemoPage() {
    ...
    const features = [
        { icon: Camera, title: "AI-анализ фото", description: "Загрузите фото кожи для детального анализа" },
        { icon: MessageCircle, title: "Чат с косметологом", description: "Получите персональные рекомендации 24/7" },
        { icon: Calendar, title: "Календарь ухода", description: "Планируйте процедуры и не пропускайте их" },
        { icon: TrendingUp, title: "Отслеживание прогресса", description: "Следите за улучшениями кожи" },
    ];
                ...
                <div className="grid gap-8 md:grid-cols-2">
                    ...
                    <Card glass>
                        ...
                        <CardContent className="space-y-2">
                            ...
                            <p className="text-base">Обычный текст для основного контента. Кириллица полностью поддерживается.</p>
