...
1.  **AI-Консультации (Google AI)**:
    *   Анализ текстового описания проблем кожи (Gemini Pro).
...
5.  **Анализ фото кожи (Google Vision AI)**:
    *   Загрузка фото и анализ состояния кожи (акне, морщины, поры) с помощью Gemini Pro Vision.
...
*   **AI**: Google Generative AI (Gemini Pro, Gemini Pro Vision).

### 3.2 Технологический стек
*   **Язык**: TypeScript.
*   **Пакетный менеджер**: Bun.
*   **Стилизация**: Tailwind CSS + Shadcn UI (“Premium” customization).
*   **Анимации**: Framer Motion (для создания "Wow"-эффекта).
...
1.  Supabase Edge Function для проксирования запросов к OpenAI.
